...
Appointments
Upcoming / past bookings, cancel/reschedule, cancel by reference code (with reference existence validation), join virtual consultation
Medical Records
Categorized EHR view, upload with file format validation (restricting uploads to PDF, JPG, PNG, and DICOM, rejecting others), search, share with doctor/insurance
Prescriptions
