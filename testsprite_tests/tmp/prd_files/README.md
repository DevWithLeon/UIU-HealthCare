...
- **User Authentication**: Role-based signup and login (Patient, Doctor, Hospital, Admin) using JWT and bcrypt hashing.
...
- **Appointment Scheduling**: Search, view, and book appointments with verified doctors.
- **Electronic Health Records**: Secure uploading and storage of lab reports and medical history.
